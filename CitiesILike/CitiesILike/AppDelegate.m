...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSString *plistFilePathInDocumentsDirectory = [documentsDirectoryPath stringByAppendingPathComponent:@"CountryCities.plist"];
    
    // Instantiate a modifiable dictionary and initialize it with the content of the plist file
    NSMutableDictionary *countryCitiesData = [[NSMutableDictionary alloc] initWithContentsOfFile:plistFilePathInDocumentsDirectory];
    ...
    if (!countryCitiesData) {
         ...
         */
        NSString *plistFilePathInMainBundle = [[NSBundle mainBundle] pathForResource:@"CountryCities" ofType:@"plist"];
        
        // Instantiate a modifiable dictionary and initialize it with the content of the plist file in main bundle
        countryCitiesData = [[NSMutableDictionary alloc] initWithContentsOfFile:plistFilePathInMainBundle];
    }
    
    self.countryCities = countryCitiesData;
...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    [self.countryCities writeToFile:plistFilePathInDocumentsDirectory atomically:YES];
    /*
