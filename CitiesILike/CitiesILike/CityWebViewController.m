...
@interface CityWebViewController ()

@end

@implementation CityWebViewController
...
- (void)viewDidLoad {
    ...
    NSString *websiteURL = [[NSString alloc] initWithFormat:@"http://en.wikipedia.org/wiki/%@", selectedCityNameWithNoSpaces];
