...
#import "KeyPlayViewController.h"

@interface KeyPlayViewController ()

@end

@implementation KeyPlayViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSURL *soundFileURL = [[NSBundle mainBundle] URLForResource: @"keyPlay" withExtension: @"wav"];
