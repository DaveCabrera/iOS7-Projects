...
#import "HokiePokieViewController.h"

@interface HokiePokieViewController ()

@end

@implementation HokiePokieViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSURL *soundFileURL = [[NSBundle mainBundle] URLForResource: @"hokiePokie" withExtension: @"wav"];    
