...
{
    // hold the menu items
    self.btMenu = @[@"Aquatic Center Hours", @"Athletic Fields", @"Community Center Hours", @"Ellett Valley Recreational Area", @"Heritage Community Park and Natural Area", @"Huckleberry Trail", @"Municipal Golf Course Programs", @"Municipal Park"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([cellText isEqualToString:@"Aquatic Center Hours"])
    {
        self.urlOfWebsite = @"http://www.blacksburg.gov/Index.aspx?page=1518";
        self.titleName = @"Aquatic Center Hours";
        [self performSegueWithIdentifier:@"Website" sender:self];
    }
    if ([cellText isEqualToString:@"Athletic Fields"])
    {
        self.urlOfWebsite = @"http://www.blacksburg.gov/Index.aspx?page=767";
        self.titleName = @"Athletic Fields";
        [self performSegueWithIdentifier:@"Website" sender:self];
    }
    if ([cellText isEqualToString:@"Community Center Hours"])
    {
        self.urlOfWebsite = @"http://www.blacksburg.gov/Index.aspx?page=586";
        self.titleName = @"Community Center Hours";
        [self performSegueWithIdentifier:@"Website" sender:self];
    }
    if ([cellText isEqualToString:@"Ellett Valley Recreational Area"])
    {
        self.urlOfWebsite = @"http://www.blacksburg.gov/Index.aspx?page=1437";
        self.titleName = @"Ellett Valley Recreational Area";
        [self performSegueWithIdentifier:@"Website" sender:self];
    }
    if ([cellText isEqualToString:@"Heritage Community Park and Natural Area"])
    {
        self.urlOfWebsite = @"http://www.blacksburg.gov/Index.aspx?page=1164";
        self.titleName = @"Heritage Community Park and Natural Area";
        [self performSegueWithIdentifier:@"Website" sender:self];
    }
    if ([cellText isEqualToString:@"Huckleberry Trail"])
    {
        self.urlOfWebsite = @"http://www.blacksburg.gov/Index.aspx?page=808";
        self.titleName = @"Huckleberry Trail";
        [self performSegueWithIdentifier:@"Website" sender:self];
    }
    if ([cellText isEqualToString:@"Municipal Golf Course Programs"])
    {
        self.urlOfWebsite = @"http://www.golfthehill.com/golf-programs";
        self.titleName = @"Municipal Golf Course Programs";
        [self performSegueWithIdentifier:@"Website" sender:self];
    }
    if ([cellText isEqualToString:@"Municipal Park"])
    {
        self.urlOfWebsite = @"http://www.blacksburg.gov/Index.aspx?page=1860";
        self.titleName = @"Municipal Park";
        [self performSegueWithIdentifier:@"Website" sender:self];
    }
}
